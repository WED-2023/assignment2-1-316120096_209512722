<template>
  <div class="favorites-page">
    <h1 class="title">Culinary Gems 💎🍽️</h1>
    ...
    <div class="recipes-grid">
      ...
      <div v-else-if="error" class="error">
        ...
        <p>{{ error }}</p>
        <button @click="updateFavorites" class="retry-btn">Retry</button>
      </div>
      <div v-else-if="favorites.length > 0" class="recipe-list">
        <div v-for="recipe in favorites" :key="recipe.id" class="recipe-item">
          ...
          <div class="recipe-info">
            ...
            <div class="recipe-meta">
              <span
                ...
                {{ recipe.readyInMinutes || "N/A" }} min</span
              >
              <span
                ><i class="icon-likes"></i>
                {{ recipe.aggregateLikes || "N/A" }} likes 🩵</span
              >
            </div>
          </div>
        </div>
      ...
      <div v-else class="no-favorites">
        ...
        <h2>Your Taste Gallery Awaits!</h2>
        <p>
          Every masterpiece starts with a blank canvas. Begin your culinary
          journey and fill this space with your favorite flavors. 🎨👨‍🍳
        </p>
        <button @click="exploreRecipes" class="explore-btn">
          Discover Recipes
        </button>
      </div>
    </div>
...
export default {
  ...
  methods: {
    async updateFavorites() {
      ...
      try {
        const response = await mockGetFavorites();
